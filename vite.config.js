  ...
  build: {
    rollupOptions: {
      input: {
        ...
        quizapp: resolve(__dirname, "gsapslider.html"),
        quizapp: resolve(__dirname, "gsapoverlay.html"),
        quizapp: resolve(__dirname, "gsapup.html"),
        quizapp: resolve(__dirname, "gsapscale.html"),
      },
    },
  },
});
