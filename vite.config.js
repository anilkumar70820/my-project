  ...
  build: {
    rollupOptions: {
      input: {
        ...
        gsap: resolve(__dirname, "gsap.html"),
        gsapslider: resolve(__dirname, "gsapslider.html"),
        gsapoverlay: resolve(__dirname, "gsapoverlay.html"),
        gsapup: resolve(__dirname, "gsapup.html"),
        gsapscale: resolve(__dirname, "gsapscale.html"),
      },
    },
  },
});
